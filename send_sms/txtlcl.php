...
function process_cf7_and_send_sms( $contact_data ){
	...
	if (isset($_POST[$phone_field])) {
        ...
        if ($submission) {
            // get submission data
            $txtlcl_api = get_option('cspd_cf7_txtlcl_api');
            $txtlcl_sender = get_option('cspd_cf7_txtlcl_sender');
           ...
           if (get_option('cf7_enable_user_sms')=="checked") {
                    ...
                    $respns = cspd_send_textlocal_sms($txtlcl_api,$txtlcl_sender,$user_phone_num,$user_sms_txt);
                    // echo "<pre>"; print_r($respns); echo "</pre><br><br><br>";
           ...
           if (get_option('cf7_enable_admin_sms')=="checked") {
                   ...
                   $rspnse = cspd_send_textlocal_sms($txtlcl_api,$txtlcl_sender,$admin_phone_num,$admin_sms_txt);
                   // echo "<pre>"; print_r($rspnse); echo "</pre>";
           }
