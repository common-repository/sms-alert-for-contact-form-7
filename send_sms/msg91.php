...
function process_cf7_and_send_sms( $contact_data ){
	...
	if (isset($_POST[$phone_field])) {
        ...
        if ($submission) {
            // get submission data
            $msg91_authkey = get_option('cspd_cf7_msg91_key');
            $msg91_senderid = get_option('cspd_cf7_msg91_sender_id');
           ...
           if (get_option('cf7_enable_user_sms')=="checked") {
                    ...
                    $msg91_respnse = cspd_cf7_send_msg91_sms($msg91_authkey, urlencode($user_sms_txt), $msg91_senderid,$user_phone_num);
                    // echo "<pre>"; print_r($msg91_respnse); echo "</pre><br>";
           ...
           if (get_option('cf7_enable_admin_sms')=="checked") {
                   ...
                   // echo $admin_sms_txt;
                    ...
                    $msg91_respnse = cspd_cf7_send_msg91_sms($msg91_authkey, $admin_sms_txt, $msg91_senderid,$admin_phone_num);
                    // echo "<pre>"; print_r($msg91_respnse); echo "</pre>";
